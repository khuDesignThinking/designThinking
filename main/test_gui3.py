...
class Ui_MainWindow(object):
    ...
    def dialog_status_update(self):
        while(True):
            ...
            if(cnt_blink <=1):
              self.labDialog.setPixmap(QtGui.QPixmap("resource/image/red.png"))
            elif(1 < cnt_blink <=3):
               self.labDialog.setPixmap(QtGui.QPixmap("resource/image/yellow.png"))
            elif(cnt_blink >3):
               self.labDialog.setPixmap(QtGui.QPixmap("resource/image/green.png"))
