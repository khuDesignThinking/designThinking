...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView.setGeometry(QtCore.QRect(30, 350, 691, 191))
        ...
        self.start_btn.clicked.connect(self.update_status)
    ...
    def update_status(self, gray):
        cnt_blink = thread.detect_blink(gray)
        if(cnt_blink <=1):
